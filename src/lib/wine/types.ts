...
export type AnalysisLocale = "en" | "fr" | "zh";
...
export interface UploadMeta {
  ...
  size: number;
  mime: string;
  /** Bounded UTF-8 text used by the lightweight private-document RAG path. */
  content?: string;
}
...
export interface AnalyzeInput {
  ...
  timeframe: Timeframe;
  persona: Persona;
  /** Requested language for all LLM-generated user-facing prose. */
  locale?: AnalysisLocale;
  /** Optional natural-language refinement, e.g. "focus on frost risk in April". */
  question?: string;
  /** Vineyard-uploaded TXT/CSV documents, including bounded UTF-8 content. */
  uploads?: UploadMeta[];
  /**
